               ...
               <div class="col-lg-12">
                  ...
                  <hr>
                     <?php foreach($events as $key => $value) : ?>
                        ...
                        ?>
                     <div id="portlet-<?=$key.rand(1,11000); ?>" data-toggle="portlet" class="col-lg-4 col-lg-offset-4">
                           <div id="panelPortlet<?=$key.rand(1,11000); ?>" class="panel panel-info">
                              <div class="panel-heading portlet-handler"><?=$e->monitor->Monitor->Name?> (<?=$value->Event->Name; ?>)
                              ...
                              <div class="panel-wrapper">
                                 ...
                                 <center>
                                 <img src="<?=PATH;?>zm/?view=image&eid=<?=$value->Event->Id;?>&fid=1" class="img-responsive"><br>
                                    <b>Start Time: <?=$_POST['start']; ?></b><br>
                                    <b>End Time: <?=$_POST['end']; ?></b><br>
                                    <b>Monitor ID: <?=$_POST['monitor']; ?></b>
                                 </div>
                                 <div class="panel-footer"> Playback Option
