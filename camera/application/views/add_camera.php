                  ...
                  <form method="post" data-parsley-validate="" novalidate="" action="<?=site_url('main/add_camera_form'); ?>">
                     ...
                     <div class="panel panel-default">
                        <div class="panel-heading">
                           <div class="panel-title">Add Camera</div>
                        </div>
                        <div class="panel-body">
                           <div class="col-lg-12">
                           <div class="form-group">
                              <label class="control-label">Camera name *</label>
                              <input name="name" required="" class="form-control" type="text" placeholder="Camera name (eg. Demo)">
                           </div>
                           </div>
                           <div class="col-lg-6">
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input name="path" required="" class="form-control" type="text" placeholder="Full path (eg. rtsp://admin:admin@192.168.1.168/mainStream)">
                           </div>
                           </div>
                           <div class="col-lg-4">
                           <div class="form-group">
                              <label class="control-label">Port *</label>
                              <input name="port" required="" class="form-control" type="text" placeholder="Port (eg. 80)">
                           </div>
                           </div>
                           <div class="col-lg-4">
                           <div class="form-group">
                              <label class="control-label">Width</label>
                              <input name="width" required="" class="form-control" type="text" placeholder="Width (eg. 1280)" value="1280">
                           </div>
                           </div>
                           <div class="col-lg-4">
                           <div class="form-group">
                              <label class="control-label">Height</label>
                              <input name="height" required="" class="form-control" type="text" placeholder="Height (eg. 720)" value="720">
                           </div>
                           </div>
                           <div class="col-lg-4">
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input name="location" required="" class="form-control" type="text" placeholder="Location (eg. Area)" id="location">
                           </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group">
                        ...
                        <div class="panel-footer">
                           <button type="submit" class="btn btn-primary">Add new Monitor</button>
