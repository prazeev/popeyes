         ...
         <div class="content-wrapper">
            ...
            <div class="panel panel-primary">
               ...
               <div class="panel-body">
                  <div class="col-md-8">
                     <img src="<?=PATH; ?>/zm/cgi-bin/nph-zms?mode=jpeg&scale=100&maxfps=25&buffer=1000&monitor=<?=$monitor->Monitor->Id; ?>&connkey=<?php $rand=rand(111111,999999); echo $rand; ?>&rand=12545455546546" class="img img-responsive">
                  </div>
